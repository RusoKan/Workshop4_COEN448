...
public class BCC_Testing {

    /* ==============================
     * SolutionOne – BCC
     * ============================== */
    @ParameterizedTest
    @CsvFileSource(resources = "/bcc_tests.csv", numLinesToSkip = 1)
    void testSolutionOne_BCC(String graphStr, String expected) {
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/bcc_tests.csv", numLinesToSkip = 1)
    void testSolutionTwo_BCC(String graphStr, String expected) {
        runTest(new SolutionTwo(), graphStr, expected);
    }

    /* ==============================
     * SolutionOneWithBug – BCC
     * ============================== */
    @ParameterizedTest
    @CsvFileSource(resources = "/bcc_tests.csv", numLinesToSkip = 1)
    void testSolutionOneWithBug_BCC(String graphStr, String expected) {
